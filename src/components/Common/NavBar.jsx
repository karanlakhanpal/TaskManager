    ...
    return (
        ...
        <div className="bg-black bg-opacity-80 p-3 sm:p-5">
            <div className="flex items-center justify-between">
                <h1 className="text-xl sm:text-2xl font-bold text-white">TaskManager</h1>
                ...
                <div className={`flex flex-row hidden sm:flex `}>
                    <ul className='mt-2 sm:mt-0 flex sm:flex-row sm:gap-x-5'>
            ...
            <div className={`flex sm:hidden ${menuOpen ? 'hidden' : 'flex-col'}`}>
