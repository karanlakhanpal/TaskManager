                ...
                <div className={`flex-row hidden sm:flex`}>
                    <ul className="sm:mt-0 flex sm:flex-row sm:gap-x-5">
                        <li className="text-white hover:underline mb-2 sm:mb-0">
                            <NavLink className={({ isActive }) => isActive ? 'text-[#0078b9]' : 'text-white'} to="/dashboard">Dashboard</NavLink>
                        </li>
                        <li className="text-white hover:underline mb-2 sm:mb-0">
                            <NavLink className={({ isActive }) => isActive ? 'text-[#0078b9]' : 'text-white'} to="/tasks">Tasks</NavLink>
                        </li>
                        <li className="text-white hover:underline mb-2 sm:mb-0">
                            <NavLink className={({ isActive }) => isActive ? 'text-[#0078b9]' : 'text-white'} to="/profile">Profile</NavLink>
                        </li>
                        <li className="text-white hover:underline mb-2 sm:mb-0">
                            <NavLink className={({ isActive }) => isActive ? 'text-[#0078b9]' : 'text-white'} to="/settings">Settings</NavLink>
                        </li>
                    </ul>
                </div>
            </div>
